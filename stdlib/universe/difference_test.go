...
func TestDifference_Process_With_InitialZero(t *testing.T) {
	testCases := []struct {
		name    string
		spec    *universe.DifferenceProcedureSpec
		data    []flux.Table
	...
	}{
		{
			...
			want: []*executetest.Table{{
				...
				Data: [][]interface{}{
					{execute.Time(1), int64(0)},
					{execute.Time(2), int64(10)},
					{execute.Time(3), int64(10)},
					{execute.Time(4), int64(20)},
				},
			}},
		},
		{
